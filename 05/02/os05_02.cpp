...
int main(int argc, char* argv[])
{
	try {
		if (argc == 4) {
			...
			if (CreateProcess(an, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE | p2, NULL, NULL, &si1, &pi1)) {
				cout << "--Process OS05_02 1 created\n";
			}
			else {	cout << "--Process OS05_02 1 not created\n";}

			if (CreateProcess(an, NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE | p3, NULL, NULL, &si2, &pi2)) {
				cout << "--Process OS05_02 2 created\n";
			}
			else {cout << "--Process OS05_02 2 not created\n";}
