...

{
	...
	wcscat_s(szKey, szCLSID);
	SEQ;
	LOG("Unregister szKey: ", szKey);
	LOG("Unregister szVerIndProgID: ", szVerIndProgID);
	LOG("Unregister szProgID: ", szProgID);
...
STDAPI DllRegisterServer() 
{
	...
	HRESULT rc = RegisterServer(hmodule, CLSID_CA, FNAME, VINDX, PGID);
...
STDAPI DllUnregisterServer() 
{
	...
	HRESULT rc = UnregisterServer(CLSID_CA, VINDX, PGID);
