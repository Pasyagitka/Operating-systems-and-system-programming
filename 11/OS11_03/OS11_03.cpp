...
int main(int argc, char** argv)
{
	try
	{
		...
		HTHANDLE* (*DeleteFunc)(HTHANDLE*, Element*) = (HTHANDLE * (*)(HTHANDLE*, Element*))GetProcAddress(hDLL, "Delete");
		...
		for (int i = 0; ; i++)
		{
			...
			if (!DeleteFunc(HT, elInsert1)) cout << "Last error: " << (GetLastErrorHTFunc(HT)) << endl;
